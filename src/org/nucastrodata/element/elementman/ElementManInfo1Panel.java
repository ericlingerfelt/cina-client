...
public class ElementManInfo1Panel extends JPanel implements ActionListener{
	 ...
	 * @param ds the ds
	 */
	public ElementManInfo1Panel(ElementManDataStructure ds){
		...
		topLabel.setText("<html>With the Element Synthesis Simulation Info tool, you can view information regarding element synthesis simulations selected below.</html>");
	...
	public void setCurrentState(){
		tree.setCurrentState(ds.getSimMap(), false);
