...
public class ThermoManInfo2Panel extends JPanel implements ActionListener{
	...
	public ThermoManInfo2Panel(MainDataStructure mds, ThermoManDataStructure ds, ThermoManFrame frame){
	...
	private String getTextString(){
		...
		while(itr.hasNext()){
			ThermoProfileSetDataStructure tpsds = ds.getSetMapSelected().get(itr.next());
