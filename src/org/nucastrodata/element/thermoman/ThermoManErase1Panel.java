...
import org.nucastrodata.element.thermoman.ThermoManSetTree;
import org.nucastrodata.wizard.gui.WordWrapLabel;

public class ThermoManErase1Panel extends JPanel implements ActionListener{
	 ...
	 * @param ds the ds
	 */
	public ThermoManErase1Panel(ThermoManDataStructure ds){
		
		this.ds = ds;
		
		WordWrapLabel topLabel = new WordWrapLabel(true);
		topLabel.setText("<html>With the Erase Thermodynamic Profiles tool, you can delete sets of thermodynamic profiles from your User storage folder.</html>");
