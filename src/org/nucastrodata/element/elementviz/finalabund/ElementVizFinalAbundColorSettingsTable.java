...
/**
 * The Class ElementVizFinalAbundColorSettingsTable.
 */
public class ElementVizFinalAbundColorSettingsTable extends JTable{
	...
	/**
	 * Instantiates a new element viz final abund color settings table.
	 *
	 * @param ds the ds
	 */
	public ElementVizFinalAbundColorSettingsTable(ElementVizDataStructure ds){
	...
	public void setCurrentState(int numBin){
		...
		tableModel.setDataVector(ds.getFinalWeightedAbundBinData(), colNamesAbundVector);
		...
		ds.setFinalWeightedAbundBinData(tableModel.getDataVector());
