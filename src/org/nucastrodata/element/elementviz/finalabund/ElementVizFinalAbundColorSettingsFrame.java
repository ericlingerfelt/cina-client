...
import org.nucastrodata.element.elementviz.finalabund.ElementVizFinalAbundColorSettingsTable;


/**
 * The Class ElementVizFinalAbundColorSettingsFrame.
 */
public class ElementVizFinalAbundColorSettingsFrame extends JFrame implements ItemListener, ActionListener, ChangeListener, WindowListener{
	...
	/** The table. */
	ElementVizFinalAbundColorSettingsTable table;
	
	/** The element viz final abund color settings help frame. */
	public HelpFrame elementVizFinalAbundColorSettingsHelpFrame;
	...
	/**
	 * Instantiates a new element viz final abund color settings frame.
	 *
	 * @param ds the ds
	 */
	public ElementVizFinalAbundColorSettingsFrame(ElementVizDataStructure ds){

		this.ds = ds;

		setTitle("Final Weighted Abundance Color Scale Settings");
		...
		topLabel = new JLabel("<html>With this tool, you can set the floor and ceiling of the final weighted abundance color scale<p>and select a new color scheme for final weighted abundance by using the sliders below.</html>");
		...
		table = new ElementVizFinalAbundColorSettingsTable(ds);
		table.validate();
	...
	public void closeAllFrames(){
		if(elementVizFinalAbundColorSettingsHelpFrame!=null){
			elementVizFinalAbundColorSettingsHelpFrame.setVisible(false);
			elementVizFinalAbundColorSettingsHelpFrame.dispose();
		}
	}
	...
	public void setFormatLayout(String scheme){
		...
		if(scheme.equals("Continuous")){
			...
			topLabel.setText("<html>With this tool, you can set the floor and ceiling of the final weighted abundance color scale<p>and select a new color scheme for final weighted abundance by using the sliders below.</html>");
	...
	public void setCurrentState(String scheme){
		...
		if(scheme.equals("Continuous")){
			...
			elementVizRainbowPanel.x0R = ds.getFinalWeightedAbundColorValues()[0];
			elementVizRainbowPanel.x0G = ds.getFinalWeightedAbundColorValues()[1];
			elementVizRainbowPanel.x0B = ds.getFinalWeightedAbundColorValues()[2];
			elementVizRainbowPanel.aR = ds.getFinalWeightedAbundColorValues()[3];
			elementVizRainbowPanel.aG = ds.getFinalWeightedAbundColorValues()[4];
			elementVizRainbowPanel.aB = ds.getFinalWeightedAbundColorValues()[5];
			
			min = Cina.elementVizFrame.elementVizFinalAbundFrame.getFinalAbundMin();
			max = Cina.elementVizFrame.elementVizFinalAbundFrame.getFinalAbundMax();

			elementVizRainbowPanel.repaint();
			
			setFormatLayout(scheme);
			
			minField.setText(Cina.elementVizFrame.elementVizFinalAbundFrame.minField.getText());
			maxField.setText(Cina.elementVizFrame.elementVizFinalAbundFrame.maxField.getText());
			
			minSlider.setMinimum(getIntegerValue(min, min, max));											
			minSlider.setMaximum(getIntegerValue(max, min, max));
													
			minSlider.setValue(getIntegerValue(Double.valueOf(Cina.elementVizFrame.elementVizFinalAbundFrame.minField.getText()).doubleValue()
													, min, max));
			
			maxSlider.setMinimum(getIntegerValue(min, min, max));
			maxSlider.setMaximum(getIntegerValue(max, min, max));
			
			maxSlider.setValue(getIntegerValue(Double.valueOf(Cina.elementVizFrame.elementVizFinalAbundFrame.maxField.getText()).doubleValue()
													, min, max));
			...
			int numBin = ds.getFinalWeightedAbundBinData().size();
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(ae.getSource()==defaultButton){
			...
			if(scheme.equals("Continuous")){
				...
				ds.setFinalWeightedAbundBinData(abundColumnData);
					...
					public Object construct(){
						...
						if(scheme.equals("Continuous")){
							...
							if(goodContInterval()){
								...
								ds.setFinalWeightedAbundColorValues(tempArray);						
								Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizRainbowPanel.setType("Abundance", scheme);
								Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizRainbowPanel.setRGB(tempArray);
								Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMin = Float.valueOf(minField.getText()).floatValue();
								Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMax = Float.valueOf(maxField.getText()).floatValue();
								Cina.elementVizFrame.elementVizFinalAbundFrame.setMinFinalAbund(Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMin);
					    		Cina.elementVizFrame.elementVizFinalAbundFrame.setMaxFinalAbund(Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMax);
								
								ds.setFinalWeightedAbundScheme(scheme);
								ds.setFinalWeightedAbundIncludeValues(includeRadioButton.isSelected());
								Cina.elementVizFrame.elementVizFinalAbundFrame.setChartColors(scheme);
								Cina.elementVizFrame.elementVizFinalAbundFrame.setFormatLayout();
								Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizFinalAbundPanel.setCurrentState(scheme);
								Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizFinalAbundPanel.repaint();
								Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizRainbowPanel.repaint();
								...
								Dialogs.createExceptionDialog(string, Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizFinalAbundColorSettingsFrame);
							...
							if(goodBinIntervals(table.tableModel.getDataVector())){
									...
									ds.setFinalWeightedAbundScheme(scheme);
									ds.setFinalWeightedAbundBinData(table.tableModel.getDataVector());
									Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizRainbowPanel.setType("Abundance", scheme);
									Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMax = (float)Math.pow(10,((Integer)(table.tableModel.getValueAt(0, 1))).intValue());
									Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMin = (float)Math.pow(10,((Integer)((Vector)(table.tableModel.getDataVector().elementAt(table.tableModel.getDataVector().size()-1))).elementAt(0)).intValue());
									Cina.elementVizFrame.elementVizFinalAbundFrame.setMinFinalAbund(Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMin);
						    		Cina.elementVizFrame.elementVizFinalAbundFrame.setMaxFinalAbund(Cina.elementVizFrame.elementVizFinalAbundFrame.finalAbundMax);																											
									Cina.elementVizFrame.elementVizFinalAbundFrame.setChartColors(scheme);
									Cina.elementVizFrame.elementVizFinalAbundFrame.elementVizFinalAbundPanel.setCurrentState(scheme);																		
			...
			elementVizFinalAbundColorSettingsHelpFrame = new HelpFrame("Help on Final Weighted Abundance Color Scale Settings", "ElementVizFinalAbundColorSettings");
			elementVizFinalAbundColorSettingsHelpFrame.setVisible(true);
	...
	public void openDelayDialog(Frame frame){
		...
		String delayString = "Please be patient while applying new settings. DO NOT operate the Final Weighted Abundance Color Scale Settings interface at this time!";
