...
/**
 * The Class ElementVizWeightChartPanel.
 */
public class ElementVizWeightChartPanel extends JPanel implements MouseListener, MouseMotionListener, Scrollable{
   ...
   static int[] minDripN;
    ...
    /** The init weight color. */
    Color initWeightColor = new Color(230,185,0);
    ...
    /**
     * Instantiates a new element viz weight chart panel.
     *
     * @param ds the ds
     */
    public ElementVizWeightChartPanel(ElementVizDataStructure ds){
	...
	public boolean goodIsotopeList(){
		...
		return Cina.cinaCGIComm.doCGICall("GET RATE LIBRARY ISOTOPES", Cina.elementVizFrame.elementVizWeightPlotFrame);
	...
	public int[] getZList(){
		...
		ZList = ds.getIsotopePadLibraryDataStructure().getZList();
	...
	public int[][] getIsotopeList(){
		...
		isotopeList = ds.getIsotopePadLibraryDataStructure().getIsotopeList();
	...
	public void setCurrentState(){
		...
		isotopeViktor = ds.getIsotopeViktorWeight();
	...
	public void getCurrentState(){
		...
		ds.setIsotopeViktorWeight(isotopeViktor);
    ...
    public void mouseEntered(MouseEvent me) {
    	...
    	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.ZRuler.setPreferredWidth((int)getSize().getWidth());
       	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.NRuler.setPreferredHeight((int)getSize().getHeight());
       	
       	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.ZRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);	
    	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.NRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);
    ...
    public void mouseExited(MouseEvent me) {
    	...
    	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.elementField.setText("");
    	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.zField.setText("");	
    	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.aField.setText("");
	...
	public void mouseMoved(MouseEvent me){
        ...
        if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
        	...
        	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.aField.setText(String.valueOf((int)neutronNumber + (int)protonNumber));
        
        	Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.zField.setText(String.valueOf((int)protonNumber));
        
        	if((int)protonNumber>=2){
        	
		        Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.elementField.setText(Cina.cinaMainDataStructure.getElementSymbol((int)protonNumber));
		    	
	    	}else if((int)protonNumber==0){
	    	
	    		Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.elementField.setText("n");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==0){
	    	
	    		Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.elementField.setText("p");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==1){
	    	
	    		Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.elementField.setText("d");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==2){
	    	
	    		Cina.elementVizFrame.elementVizWeightPlotFrame.elementVizWeightChartControlsPanel.elementField.setText("t");
