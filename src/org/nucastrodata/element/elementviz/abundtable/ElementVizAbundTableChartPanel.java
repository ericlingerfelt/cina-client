...
/**
 * The Class ElementVizAbundChartPanel.
 */
public class ElementVizAbundTableChartPanel extends JPanel implements MouseListener, MouseMotionListener, Scrollable{
   ...
   static int[] minDripN;
    ...
    /**
     * Instantiates a new element viz abund chart panel.
     *
     * @param ds the ds
     */
    public ElementVizAbundTableChartPanel(ElementVizDataStructure ds){
	...
	public void initialize(){
        ...
        setPreferredSize(new Dimension(xmax+xoffset,ymax+yoffset));
	...
	public boolean goodIsotopeList(){
    	...
    	ds.setIsotopePadLibraryDataStructure(new LibraryDataStructure());
		ds.setLibraryName("ReaclibV2.2");
					
		return Cina.cinaCGIComm.doCGICall("GET RATE LIBRARY ISOTOPES", Cina.elementVizFrame.elementVizAbundTableFrame);
	 ...
	 * @return the z list
	 */
	public int[] getZList(){return ds.getIsotopePadLibraryDataStructure().getZList();}
	 ...
	 */
	public int[][] getIsotopeList(){return ds.getIsotopePadLibraryDataStructure().getIsotopeList();}
	...
	public void setCurrentState(){
		...
		isotopeViktor = ds.getIsotopeViktorAbundTable();
	...
	public void getCurrentState(){
		...
		ds.setIsotopeViktorAbundTable(isotopeViktor);
    ...
    public void mouseEntered(MouseEvent me) {
    	...
    	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.ZRuler.setPreferredWidth((int)getSize().getWidth());
       	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.NRuler.setPreferredHeight((int)getSize().getHeight());
       	
       	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.ZRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);	
    	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.NRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);
    ...
    public void mouseExited(MouseEvent me) {
    	...
    	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.elementField.setText("");
    	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.zField.setText("");	
    	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.aField.setText("");
	...
	public void mouseReleased(MouseEvent me) {
		...
		for(int i=0; i<protonNumberDragVector.size(); i++){
			...
			for(int j=0; j<neutronNumberDragVector.size(); j++){
				...
				if(!isotopeViktor.contains(new Point(z, n))){
				
					isotopeViktor.addElement(new Point(z, n));
	...
	public void mouseMoved(MouseEvent me){
        ...
        if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
        	...
        	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.aField.setText(String.valueOf((int)neutronNumber + (int)protonNumber));
        
        	Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.zField.setText(String.valueOf((int)protonNumber));
        
        	if((int)protonNumber>=2){
        	
		        Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.elementField.setText(Cina.cinaMainDataStructure.getElementSymbol((int)protonNumber));
		    	
	    	}else if((int)protonNumber==0){
	    	
	    		Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.elementField.setText("n");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==0){
	    	
	    		Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.elementField.setText("p");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==1){
	    	
	    		Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.elementField.setText("d");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==2){
	    	
	    		Cina.elementVizFrame.elementVizAbundTableFrame.elementVizAbundTableChartControlsPanel.elementField.setText("t");
