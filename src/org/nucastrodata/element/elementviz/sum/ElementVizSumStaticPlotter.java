 ...
 */
public class ElementVizSumStaticPlotter extends JFrame {
			...
			for(k=0; k<npoints[i]; k++){
				...
				case 1:                 // log-lin plot
					...
					if(yy[i][k]<=0.0){
						...
						g2.drawString("There is at least one data point that is equal to zero.",x1+10,y1+20);
						g2.drawString("Please select the lin scale from the right to view this dataset.",x1+10,y1+35);
