 ...
 */
public class ElementVizAbundChartPanel extends JPanel implements MouseListener, MouseMotionListener, Scrollable{
   ...
   static int[] minDripN;
     ...
     * @param ds the ds
     */
    public ElementVizAbundChartPanel(ElementVizDataStructure ds){
	...
	public boolean goodIsotopeList(){
		...
		return Cina.cinaCGIComm.doCGICall("GET RATE LIBRARY ISOTOPES", Cina.elementVizFrame.elementVizAbundPlotFrame);
	...
	public void setCurrentState(){
		...
		isotopeViktor = ds.getIsotopeViktorAbund();
	...
	public void getCurrentState(){
		...
		ds.setIsotopeViktorAbund(isotopeViktor);
    ...
    public void mouseEntered(MouseEvent me) {
    	...
    	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.ZRuler.setPreferredWidth((int)getSize().getWidth());
       	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.NRuler.setPreferredHeight((int)getSize().getHeight());
       	
       	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.ZRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);	
    	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.NRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);
    ...
    public void mouseExited(MouseEvent me) {
    	...
    	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.elementField.setText("");
    	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.zField.setText("");	
    	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.aField.setText("");
	...
	public void mouseMoved(MouseEvent me){
        ...
        if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
        	...
        	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.aField.setText(String.valueOf((int)neutronNumber + (int)protonNumber));
        
        	Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.zField.setText(String.valueOf((int)protonNumber));
        
        	if((int)protonNumber>=2){
        	
		        Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.elementField.setText(Cina.cinaMainDataStructure.getElementSymbol((int)protonNumber));
		    	
	    	}else if((int)protonNumber==0){
	    	
	    		Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.elementField.setText("n");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==0){
	    	
	    		Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.elementField.setText("p");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==1){
	    	
	    		Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.elementField.setText("d");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==2){
	    	
	    		Cina.elementVizFrame.elementVizAbundPlotFrame.elementVizAbundChartControlsPanel.elementField.setText("t");
