...
/**
 * The Class RateManInvestRateIsotopePadPanel.
 */
public class RateManInvestRateIsotopePadPanel extends JPanel implements MouseListener, MouseMotionListener, Scrollable{
   ...
   static int[] minDripN;
    ...
    /**
     * Instantiates a new rate man invest rate isotope pad panel.
     *
     * @param ds the ds
     */
    public RateManInvestRateIsotopePadPanel(RateManDataStructure ds){
	...
	public void initialize(){
		...
		if(Cina.cinaCGIComm.doCGICall("GET RATE LIBRARY ISOTOPES", Cina.rateManFrame)){
    ...
    public void mousePressed(MouseEvent me) {
		...
		if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
			...
			if(Cina.rateManFrame.rateManInvestRate2ChartPanel.rateListModel.size()!=0){
    ...
    public void mouseEntered(MouseEvent me) {
    	...
    	Cina.rateManFrame.rateManInvestRate2ChartPanel.ZRuler.setPreferredWidth((int)getSize().getWidth());
       	Cina.rateManFrame.rateManInvestRate2ChartPanel.NRuler.setPreferredHeight((int)getSize().getHeight());
       	
       	Cina.rateManFrame.rateManInvestRate2ChartPanel.ZRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);	
    	Cina.rateManFrame.rateManInvestRate2ChartPanel.NRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);
    ...
    public void mouseExited(MouseEvent me) {
    	...
    	Cina.rateManFrame.rateManInvestRate2ChartPanel.elementField.setText("");
    	Cina.rateManFrame.rateManInvestRate2ChartPanel.zField.setText("");	
    	Cina.rateManFrame.rateManInvestRate2ChartPanel.aField.setText("");
	...
	public void mouseMoved(MouseEvent me){
        ...
        if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
        	...
        	Cina.rateManFrame.rateManInvestRate2ChartPanel.aField.setText(String.valueOf((int)neutronNumber + (int)protonNumber));
        
        	Cina.rateManFrame.rateManInvestRate2ChartPanel.zField.setText(String.valueOf((int)protonNumber));
        
        	if((int)protonNumber>=2){
        	
		        Cina.rateManFrame.rateManInvestRate2ChartPanel.elementField.setText(Cina.cinaMainDataStructure.getElementSymbol((int)protonNumber));
		    	
	    	}else if((int)protonNumber==0){
	    	
	    		Cina.rateManFrame.rateManInvestRate2ChartPanel.elementField.setText("n");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==0){
	    	
	    		Cina.rateManFrame.rateManInvestRate2ChartPanel.elementField.setText("p");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==1){
	    	
	    		Cina.rateManFrame.rateManInvestRate2ChartPanel.elementField.setText("d");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==2){
	    	
	    		Cina.rateManFrame.rateManInvestRate2ChartPanel.elementField.setText("t");
