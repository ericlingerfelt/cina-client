...
/**
 * The Class RateGenIsotopePadPanel.
 */
public class RateGenIsotopePadPanel extends JPanel implements MouseListener, MouseMotionListener, Scrollable{
   ...
   static int[] minDripN;
    ...
    /**
     * Instantiates a new rate gen isotope pad panel.
     *
     * @param ds the ds
     */
    public RateGenIsotopePadPanel(RateGenDataStructure ds){
	...
	public void initialize(){
		...
		if(Cina.cinaCGIComm.doCGICall("GET RATE LIBRARY ISOTOPES", Cina.rateGenFrame.rateGenChartFrame)){
    ...
    public void mousePressed(MouseEvent me) {
		...
		if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
			...
			if(Cina.rateGenFrame.rateGenChartFrame.rateListModel.size()!=0){
	        ...
	        ds.setLibrary("ReaclibV2.2");
			ds.setIsotope(Cina.rateGenFrame.rateGenChartFrame.getIsotopes());
			ds.setTypeDatabase("");
	        
	        if(Cina.cinaCGIComm.doCGICall("GET RATE LIST", Cina.rateGenFrame.rateGenChartFrame)){
	        
	        	Cina.rateGenFrame.rateGenChartFrame.setRateList();
    ...
    public void mouseEntered(MouseEvent me) {
    	...
    	Cina.rateGenFrame.rateGenChartFrame.ZRuler.setPreferredWidth((int)getSize().getWidth());
       	Cina.rateGenFrame.rateGenChartFrame.NRuler.setPreferredHeight((int)getSize().getHeight());
       	
       	Cina.rateGenFrame.rateGenChartFrame.ZRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);	
    	Cina.rateGenFrame.rateGenChartFrame.NRuler.setCurrentState(zmax, nmax, mouseX, mouseY, xoffset, yoffset, crosshairsOn);
    ...
    public void mouseExited(MouseEvent me) {
    	...
    	Cina.rateGenFrame.rateGenChartFrame.elementField.setText("");
    	Cina.rateGenFrame.rateGenChartFrame.zField.setText("");	
    	Cina.rateGenFrame.rateGenChartFrame.aField.setText("");
	...
	public void mouseMoved(MouseEvent me){
        ...
        if((int)protonNumber>-1 && (neutronNumber>=minDripN[(int)protonNumber]) && (neutronNumber<=maxDripN[(int)protonNumber])){
        	...
        	Cina.rateGenFrame.rateGenChartFrame.aField.setText(String.valueOf((int)neutronNumber + (int)protonNumber));
        
        	Cina.rateGenFrame.rateGenChartFrame.zField.setText(String.valueOf((int)protonNumber));
        
        	if((int)protonNumber>=2){
        	
		        Cina.rateGenFrame.rateGenChartFrame.elementField.setText(Cina.cinaMainDataStructure.getElementSymbol((int)protonNumber));
		    	
	    	}else if((int)protonNumber==0){
	    	
	    		Cina.rateGenFrame.rateGenChartFrame.elementField.setText("n");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==0){
	    	
	    		Cina.rateGenFrame.rateGenChartFrame.elementField.setText("p");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==1){
	    	
	    		Cina.rateGenFrame.rateGenChartFrame.elementField.setText("d");
	    	
	    	}else if((int)protonNumber==1 && (int)neutronNumber==2){
	    	
	    		Cina.rateGenFrame.rateGenChartFrame.elementField.setText("t");
