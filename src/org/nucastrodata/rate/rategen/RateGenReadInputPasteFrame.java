...
/**
 * The Class RateGenReadInputPasteFrame.
 */
public class RateGenReadInputPasteFrame extends JFrame implements WindowListener, ActionListener{
	...
	/**
	 * Instantiates a new rate gen read input paste frame.
	 *
	 * @param ds the ds
	 */
	public RateGenReadInputPasteFrame(RateGenDataStructure ds){
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(ae.getSource()==pasteButton){
			...
			if(!dataTextArea.getText().equals("")){
				...
				Cina.rateGenFrame.rateGenReadInputPanel.filenameField.setText("Data Pasted");
