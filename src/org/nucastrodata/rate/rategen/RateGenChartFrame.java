...
import org.nucastrodata.rate.rategen.RateGenIsotopePadPanel;


/**
 * The Class RateGenChartFrame.
 */
public class RateGenChartFrame extends JFrame implements ActionListener, ChangeListener{

    /** The rate gen isotope pad panel. */
    static RateGenIsotopePadPanel rateGenIsotopePadPanel;
    ...
    /**
     * Instantiates a new rate gen chart frame.
     *
     * @param ds the ds
     */
    public RateGenChartFrame(RateGenDataStructure ds){
        ...
        zmaxSlider = new JSlider(JSlider.HORIZONTAL, 0, 85, rateGenIsotopePadPanel.zmax);
		zmaxSlider.addChangeListener(this);
		zmaxField.setText(Integer.toString(rateGenIsotopePadPanel.zmax));
        ...
        nmaxField.setText(Integer.toString(rateGenIsotopePadPanel.nmax));
        
        nmaxField.setEditable(false);
        
        nmaxSlider = new JSlider(JSlider.HORIZONTAL, 1, 193, rateGenIsotopePadPanel.nmax);
        ...
        rateGenIsotopePadPanel = new RateGenIsotopePadPanel(ds);
        
        rateGenIsotopePadPanel.width = (int)(rateGenIsotopePadPanel.boxWidth*(rateGenIsotopePadPanel.nmax+1));
        rateGenIsotopePadPanel.height = (int)(rateGenIsotopePadPanel.boxHeight*(rateGenIsotopePadPanel.zmax+1));
        
        rateGenIsotopePadPanel.setSize(rateGenIsotopePadPanel.width+2*rateGenIsotopePadPanel.xoffset,rateGenIsotopePadPanel.height+2*rateGenIsotopePadPanel.yoffset);
        
        rateGenIsotopePadPanel.xmax = (int)(rateGenIsotopePadPanel.xoffset + rateGenIsotopePadPanel.width);
        rateGenIsotopePadPanel.ymax = (int)(rateGenIsotopePadPanel.yoffset + rateGenIsotopePadPanel.height);

		rateGenIsotopePadPanel.setPreferredSize(rateGenIsotopePadPanel.getSize());
		
        sp = new JScrollPane(rateGenIsotopePadPanel);
		
		JViewport vp = new JViewport();
		
		vp.setView(rateGenIsotopePadPanel);
		...
		ZRuler.setPreferredWidth((int)rateGenIsotopePadPanel.getSize().getWidth());
       	NRuler.setPreferredHeight((int)rateGenIsotopePadPanel.getSize().getHeight());
       	
       	ZRuler.setCurrentState(rateGenIsotopePadPanel.zmax
								, rateGenIsotopePadPanel.nmax
								, rateGenIsotopePadPanel.mouseX
								, rateGenIsotopePadPanel.mouseY
								, rateGenIsotopePadPanel.xoffset
								, rateGenIsotopePadPanel.yoffset
								, rateGenIsotopePadPanel.crosshairsOn);
								
    	NRuler.setCurrentState(rateGenIsotopePadPanel.zmax
								, rateGenIsotopePadPanel.nmax
								, rateGenIsotopePadPanel.mouseX
								, rateGenIsotopePadPanel.mouseY
								, rateGenIsotopePadPanel.xoffset
        ...
        if(ae.getSource()==addButton){
        	...
        	rateField.setText("");
 			...
 			ds.setRateViktor(new Vector());
           	...
           	rateGenIsotopePadPanel.setCurrentState();
           	
           	rateGenIsotopePadPanel.repaint();
			...
			if(Cina.cinaCGIComm.doCGICall("CHECK REACTION", this)){
				...
				ds.getRateDataStructure().setReactionNotes(Cina.rateGenFrame.rateGenIDPanel.notesTextArea.getText());
				
				Cina.rateGenFrame.rateGenIDPanel.setCurrentState();
    ...
    public void resetChart(){
        ...
        rateGenIsotopePadPanel.zmax = zmaxSlider.getValue();
        rateGenIsotopePadPanel.nmax = nmaxSlider.getValue();
		...
		rateGenIsotopePadPanel.revalidate();
        
        sp.getHorizontalScrollBar().setMinimum(0);
		sp.getVerticalScrollBar().setMaximum(rateGenIsotopePadPanel.getHeight());
    ...
    public void setCurrentState(){
    	...
    	rateGenIsotopePadPanel.initialize();
