...
/**
 * The Class RateGenResultsPlotCanvas.
 */
public class RateGenResultsPlotCanvas extends JPanel implements MouseMotionListener, MouseListener{
	...
	//Constructor
	/**
	 * Instantiates a new rate gen results plot canvas.
	 *
	 ...
	 * @param ds the ds
	 */
	public RateGenResultsPlotCanvas(int rminInit
										, int rmaxInit
										, int tminInit
										, int tmaxInit
	...
	public void setPlotState(){
		...
		if(initFlag){
			...
			xmin = Math.pow(10, Cina.rateGenFrame.rateGenResultsPlotFrame.getTmin());
			xmax = Math.pow(10, Cina.rateGenFrame.rateGenResultsPlotFrame.getTmax());
			ymin = Math.pow(10, Cina.rateGenFrame.rateGenResultsPlotFrame.getRmin());
			ymax = Math.pow(10, Cina.rateGenFrame.rateGenResultsPlotFrame.getRmax());
			
			minorX = Cina.rateGenFrame.rateGenResultsPlotFrame.getMinorT();
			majorX = Cina.rateGenFrame.rateGenResultsPlotFrame.getMajorT();			
			minorY = Cina.rateGenFrame.rateGenResultsPlotFrame.getMinorR();
			majorY = Cina.rateGenFrame.rateGenResultsPlotFrame.getMajorR();
			
			xtickIntervals = Math.abs((int)Cina.rateGenFrame.rateGenResultsPlotFrame.getTmin()
									- (int)Cina.rateGenFrame.rateGenResultsPlotFrame.getTmax());
		
			ytickIntervals = Math.abs((int)Cina.rateGenFrame.rateGenResultsPlotFrame.getRmin()
									- (int)Cina.rateGenFrame.rateGenResultsPlotFrame.getRmax());
		
			
		}else{
					
			ytitle = ytitle + " (" + ds.getRateUnits() + ")";
			initFlag = true;
