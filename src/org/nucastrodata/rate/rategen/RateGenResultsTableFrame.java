...
/**
 * The Class RateGenResultsTableFrame.
 */
public class RateGenResultsTableFrame extends JFrame implements WindowListener
																, ActionListener{
    ...
    /**
     * Instantiates a new rate gen results table frame.
     *
     * @param ds the ds
     */
    public RateGenResultsTableFrame(RateGenDataStructure ds){
    ...
    public void setTableText(){
        ...
        double[] x = new double[ds.getNumberPointsRT()];
        double[] y = new double[ds.getNumberPointsRT()];
        
        String[] tempStringArray = new String[ds.getNumberPointsRT()];
        	
        int[] tempSpacesArray = new int[ds.getNumberPointsRT()];
        
        tableTextArea.append("Reaction Rate vs. Temperature Data for: " + reactionString + "\n\n");   
       	tableTextArea.append("Temperature(T9)  " + "Reaction Rate(" + ds.getRateUnits() + ") " + " \n\n" );
        
        for(int i=0; i<ds.getNumberPointsRT(); i++){
        	
            x[i] = ds.getTempDataArray()[i];
            y[i] = ds.getRateDataArray()[i];
