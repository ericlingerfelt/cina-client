...
/**
 * The Class RateParamInputWarningsPanel.
 */
public class RateParamInputWarningsPanel extends WizardPanel{
	...
	String[] inputWarningsStringArray = {"Reaction: "
										...
										, "Widest temperature range for rate parameterization (T9): "
	...
	//Constructor
	/**
	 * Instantiates a new rate param input warnings panel.
	 *
	 * @param ds the ds
	 */
	public RateParamInputWarningsPanel(RateParamDataStructure ds){
		
		this.ds = ds;
		
		//Set current panel index to 4
		Cina.rateParamFrame.setCurrentPanelIndex(4);
		...
		addWizardPanel("Rate Parameterizer", "Input Preprocessing Summary", "4", "12");
	...
	public void setLabels(){
		...
		//inputWarningsPanel.add(rateLabel, gbc);
