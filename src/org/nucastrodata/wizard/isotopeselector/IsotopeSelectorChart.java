...
import org.nucastrodata.wizard.isotopeselector.IsotopePointComparator;
...
public class IsotopeSelectorChart extends JPanel implements MouseListener, MouseMotionListener{
    ...
    /** The rscl. */
    private IsotopeSelectorChartListener rscl;
	 ...
	 * @param rscl the rscl
	 */
	public void initialize(IsotopePoint ip
							, RateLibDataStructure rlds
							, IsotopeSelectorChartListener rscl){
	...
	private void fillIsotopeBoxes(Graphics2D g2, Integer z){
		...
		if(rlds.getIsotopeMapFull().get(z)!=null){
