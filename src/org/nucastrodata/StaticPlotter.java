...
/**
 * The Class StaticPlotter.
 */
public class StaticPlotter extends JPanel {
	...
	public void plotIt(int plotmode,int x1,int y1,int x2,int y2,int kmax,
		...
		this.plotIt(plotmode, x1, y1, x2, y2, kmax, imax, mode, dotSize, xlegoff, ylegoff, xdplace, ydplace, npoints, doscalex, doscaley, doplot, xxmin, xxmax, yymin, yymax, delxmin, delxmax, delymin, delymax, lcolor, bgcolor, axiscolor, legendfg, framefg, dropShadow, legendbg, labelcolor, ticLabelColor, xtitle, ytitle, curvetitle, logStyle, ytickIntervals, xtickIntervals, showLegend, xx, yy, majorX, minorX, majorY, minorY, title, subtitle, titleString, subtitleString, insideLegend, location, xoffset, yoffset, topmarg, rightmarg, null, null, g);
	}
	...
	public void plotIt(int plotmode,int x1,int y1,int x2,int y2,int kmax,
			...
			String titleString, String subtitleString, 
			boolean insideLegend, String location, int xoffset, int yoffset, 
			int topmarg, int rightmarg, DecimalFormat xFormat, DecimalFormat yFormat, Graphics g){
		...
		//Variable to draw every other temp tick  
		//See about 20 lines below here;
		int didIt = 0;
		...
		for (k=0; k<=xtickIntervals; k++){
		   ...
		   if(plotmode<2){    //  If not log-log
			   ...
			   if(xFormat!=null){
				   ...
				   fshift=mediumFontMetrics.stringWidth(xFormat.format(tmark))/2;
				   g2.drawString(xFormat.format(tmark), x1+xoffset+(int)(k*ticspace)-fshift, y2-yoffset+15);
...
///////////////////////////////////////////					
					...
					if(yFormat==null){
						...
						fshift=smallFontMetrics.stringWidth(yFormat.format(yvalue));
						g2.drawString(yFormat.format(yvalue),
								x1+xoffset-fshift-5,
								y2-yoffset-(int)(k*ticspace)+vshift);
					}
				}
		...
		int d = (int)((double)(x2-rightmarg-x1-xoffset-2.0*shift)/2.0);
		...
		d = (int)((double)(x2-rightmarg-x1-xoffset-2.0*shift)/2.0);
