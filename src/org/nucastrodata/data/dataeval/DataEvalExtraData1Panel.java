...
/**
 * The Class DataEvalExtraData1Panel.
 */
public class DataEvalExtraData1Panel extends WizardPanel implements ActionListener, TreeExpansionListener{
	...
	/**
	 * Instantiates a new data eval extra data1 panel.
	 *
	 * @param ds the ds
	 */
	public DataEvalExtraData1Panel(DataEvalDataStructure ds){
		...
		addWizardPanel("Nuclear Data Evaluator's Toolkit", "Cross Section Extrapolator", "1", "2");
		...
		JLabel topLabel = new JLabel("<html>Welcome to the Cross Section Extrapolator tool.</html>");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==removeNucDataButton){
			...
			ds.getExtra1NucDataDataStructure().setNucDataID("");
			...
			if(((DefaultMutableTreeNode)(setTree.getSelectionPath().getLastPathComponent())).isLeaf()){
				...
				if(newNucData.indexOf("Reaction does not")==-1){
					ds.getExtra1NucDataDataStructure().setNucDataID(tempString);
	...
	public boolean checkNucDataField(){
		...
		if(!nucDataField.getText().equals("")){goodNucData = true;}
		return goodNucData;
	}
	...
	public void setCurrentState(){
		nucDataField.setText(ds.getCurrentNucDataString1Extra());
		rateField.setText(ds.getCurrentRateString1Extra());
		nucDataSetField.setText(ds.getCurrentNucDataSetString1Extra());
	}
	...
	public void getCurrentState(){
		ds.setCurrentNucDataString1Extra(nucDataField.getText());
		ds.setCurrentRateString1Extra(rateField.getText());
		ds.setCurrentNucDataSetString1Extra(nucDataSetField.getText());
	}
